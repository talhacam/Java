...
public class C01_Mda {
    ...
    /* tek katli arraylerde array'i direkt yazdiramiyoruz cunku array non-primitive data turudur
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(sayilar[1])); // [3,4]

        System.out.println(sayilar[0][1]); // 2 (0'ıncı inner array'inin 1.elementi)
        System.out.println(sayilar[1][0]); // 3 (1. inner array'inin 0.elementi)
