...
public class C01_ArraydenArrayListYapmak {
    ...
    public static void main(String[] args) {
        ...
        //Array'den çevirerek yapılan listelerde ekleme yada silme işlemine Java izin vermiyor.


        // 2.yan etki

        arr[1] ="Emre";  // Array değiştirildi [Ismail, Emre, Fatih]
        System.out.println("degisim sonrasi array : "+Arrays.toString(arr)); //[Ismail, Emre, Fatih]
        System.out.println("Array'i degistirince list : " + sinifList); // Array değiştirilince list de değişti [Ismail, Emre, Fatih]


        sinifList.set(0,"Utku");
        System.out.println("List'i degistirince list : " + sinifList); //[Utku, Emre, Fatih]
        System.out.println("List'i degistirince array : " + Arrays.toString(arr)); // sadece list değiştirilmiş olmasına rağmen array de değişti. [Utku, Emre, Fatih]
    }
