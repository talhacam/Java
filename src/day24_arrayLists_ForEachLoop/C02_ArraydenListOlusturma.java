    ...
    public static void main(String[] args) {
        ...
        while(sayiListesi.size()<200){
            ...
            if (!sayiListesi.contains(sayi)){
                ...
                // Buraya kadar 0 ile 999 arasında rastgele 200 tane sayıyla dolu bir liste hazırlandı.
        ...
        while(!bildiMi){ // bildiMi==false  (False ise çalışmaya devam edecek)
