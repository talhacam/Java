...
public class C02_Exceptions {
        ...
        try blogu yapmaya calistigimiz ama risk oldugunu dusundugumuz
                  ...
                  turunu Javaya soylemek icin kullanilir
                   ...
                   catch bloğunun önündeki paranteze karşılaşmayı beklediğimiz exception'i yazabilir veya
                   her trülü exception'da devreye girmesini istiyorsak tüm exception'ların parent'i olan Exception yazabiliriz.
         */
